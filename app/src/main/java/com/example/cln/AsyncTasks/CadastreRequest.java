...
public class CadastreRequest extends AsyncTask<String, Integer, Long> {

    // propriétés
    public String content = ""; // information retournée par le serveur
    ...
    protected void onPostExecute(Long result) {
        // content contient l'information récupérée
        try {
            delegate.processFinish(this.content);
